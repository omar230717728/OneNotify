        ...
        return StatefulBuilder(
          builder: (context, setState) {
            return AlertDialog(
              ...
              title: const Row(
                children: [
                  Icon(Icons.desktop_windows, color: Color(0xFF3B82F6)),
                  SizedBox(width: 12),
                  Text(
                    'Link to PC',
              ...
              content: Column(
                ...
                children: [
                  Text(
                    'Enter the 6-digit code shown on your computer screen to pair your device.',
              ...
              actions: [
                ...
                ElevatedButton(
                  ...
                  onPressed: isLoading
                      ? null
                      : () async {
                          final code = pairingController.text.trim();
                          if (code.length != 6) {
                            setState(() {
                          ...
                          try {
                            ...
                            if (context.mounted) {
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(
                                  content: Text('Success! Your PC is now linked'),
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          Padding(
            padding: const EdgeInsets.only(top: 12.0),
            child: IconButton(
              icon: const Icon(Icons.desktop_windows_rounded, color: Colors.grey, size: 26),
              tooltip: 'Link to PC',
